...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'trading_bot.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('trading_bot', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'trading_bot',
          header: 'Trading Bot',
          accessorKey: 'trading_bot',
          cell: ({ row: { original: record } }: any) => record?._count?.trading_bot,
        }
      : null,
